# SQAaaS reporting validator plugin for the gosec tool
...
## Description
This plugin validates the output of the [gosec](https://gosec.readthedocs.io/) tool."

## Quick start
The plugin can be installed from this repository using `pip`:
```
$ pip install git+https://github.com/EOSC-synergy/sqaaas-reporting-plugins@main#egg=report2sqaaas-plugin-gosec&subdirectory=qc_sec_gosec
```
### Configuration
...
```
$ report2sqaaas gosec gosec.stdout
```
