...
# SQAaaS reporting validator plugin for the is_semver.py tool
...
## Description
This plugin validates the output of the [is_semver.py](https://github.com/eosc-synergy/sqaaas-tooling) tool."

## Quick start
The plugin can be installed from this repository using `pip`:
```
$ pip install git+https://github.com/EOSC-synergy/sqaaas-reporting-plugins@main#egg=report2sqaaas-plugin-is_semver&subdirectory=qc_ver_is_semver
```
### Configuration
...
```
$ report2sqaaas is_semver is_semver.py.stdout
```
