# SQAaaS reporting validator plugin for the flake8 tool
...
## Description
This plugin validates the output of the [flake8](https://flake8.pycqa.org/) tool."

## Quick start
The plugin can be installed from this repository using `pip`:
```
$ pip install git+https://github.com/EOSC-synergy/sqaaas-reporting-plugins@main#egg=report2sqaaas-plugin-flake8&subdirectory=qc_sty_flake8
```
### Configuration
...
```
$ report2sqaaas flake8 flake8.stdout
```
