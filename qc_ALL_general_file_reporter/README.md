...
## Description
This plugin validates the output of the [pytest](https://example.org/foo) tool."

## Quick start
The plugin can be installed from this repository using `pip`:
```
$ pip install git+https://github.com/EOSC-synergy/sqaaas-reporting-plugins@main#egg=report2sqaaas-plugin-general_file_reporter&subdirectory=qc_ALL_general_file_reporter
```
### Configuration
...
```
$ report2sqaaas general_file_reporter pytest.stdout
```
