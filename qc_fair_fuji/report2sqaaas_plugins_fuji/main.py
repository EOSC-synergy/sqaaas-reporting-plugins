...
class FujiValidator(sqaaas_utils.BaseValidator):
    ...
    rda_useful = {
        ...
        "da_r1_1_01m": "Metadata includes information about the licence under which the data canbe reused",
        "rda_r1_3_01d": "Data complies with a community standard",
        "rda_r1_3_01m": "Metadata complies with a community standard",
        "rda_r1_3_02m": "Metadata is expressed in compliance with a machine-understandable community standard"}
    rda_important = {
        ...
        "rda_r1_3_02d": "Data is expressed in compliance with a machine-understandable community standard"}
    rda_essential = {
        ...
        "rda_r1_2_02m": "Metadata includes provenance information according to a cross-community language"}
    ...
    def validate(self):
        """
            ...
            "In case at least one metric of a given principle has reached level ‘initial’, the corresponding principle cannot have a lower level even if all other metrics are scored lower thus is considered to have reached the ‘initial’ level. All levels above ‘initial’ are calculated as the rounded mean of all metrics scores for a given principle.
            The overall F-UJI FAIR level for a given research data object would analogously be calculated as a rounded mean of all principle scores."
            ...
            FUJI does NOT use the RDA indicators that have been classified with a Priority level: Useful, Important, Essential.
            Neither does it use the RDA 'Measure of FAIRness' defined in 6 levels (0,1,2,3,4,5). See: https://joinup.ec.europa.eu/sites/default/files/solution/documentation/2020-07/FAIR%20Data%20Maturity%20Model_%20specification%20and%20guidelines_v1.00_0.pdf
            These levels meet the need for more flexible assignment of the badges, by looking at "half of the indicators are satisfied".
            ...
            FAIR EVA does also not use the RDA 'Measure of FAIRness', but maps the Useful, Important, Essential indicators 1:1 to a badge.
