...
class FujiValidator(sqaaas_utils.BaseValidator):
    ...
    rda_useful = {
        ...
        "rda_a1_02d": "Data can be accessed manually (i.e. with human "
                      "intervention)",
        ...
        "rda_a1_1_01m": "Metadata is accessible through a free access "
                        "protocol",
    ...
    rda_important = {
        ...
        "rda_i1_01m": "Metadata uses knowledge representation expressed in "
                      "standardised format",
        "rda_i1_02d": "Data uses machine-understandable knowledge "
                      "representation",
        ...
        "rda_i3_03m": "Metadata includes qualified references to other "
                      "metadata",
        "rda_r1_1_02m": "Metadata refers to a standard reuse licence",
        "rda_r1_1_03m": "Metadata refers to a machine-understandable reuse "
                        "licence",
    ...
    def validate(self):
        ...
        for rda_criteria in self.rda_all:
            evidence = "Found: " if passed_rd_indicators.get(rda_criteria) is \
                                    not None else "Not found: "
            subcriteria.append({
                "id": rda_criteria,
