...
# SQAaaS reporting validator plugin for the PyOphidia tool
...
## Description
This plugin validates the output of the [PyOphidia](https://github.com/OphidiaBigData/PyOphidia) tool."

## Quick start
The plugin can be installed from this repository using `pip`:
```
$ pip install git+https://github.com/EOSC-synergy/sqaaas-reporting-plugins@main#egg=report2sqaaas-plugin-Ophidia&subdirectory=qc_sty_Ophidia
```
### Configuration
...
```
$ report2sqaaas Ophidia PyOphidia.stdout
```
