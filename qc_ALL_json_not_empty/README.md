# SQAaaS reporting validator plugin for the json tool
...
## Description
This plugin validates the output of the [json](https://es.wikipedia.org/wiki/JSON) tool."

## Quick start
The plugin can be installed from this repository using `pip`:
```
$ pip install git+https://github.com/EOSC-synergy/sqaaas-reporting-plugins@main#egg=report2sqaaas-plugin-json_not_empty&subdirectory=qc_ALL_json_not_empty
```
### Configuration
...
```
$ report2sqaaas json_not_empty json.stdout
```
