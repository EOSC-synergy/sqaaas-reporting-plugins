# SQAaaS reporting validator plugin for the markdownlint tool
...
## Description
This plugin validates the output of the [markdownlint](https://github.com/markdownlint/markdownlint) tool."

## Quick start
The plugin can be installed from this repository using `pip`:
```
$ pip install git+https://github.com/EOSC-synergy/sqaaas-reporting-plugins@main#egg=report2sqaaas-plugin-markdownlint&subdirectory=qc_doc_markdownlint
```
### Configuration
...
```
$ report2sqaaas markdownlint markdownlint.stdout
```
